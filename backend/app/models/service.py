...
class Service(Base):
    ...
    is_custom_created: Mapped[bool] = mapped_column(
        Boolean, default=False, nullable=False
    )
    timer_file_path: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    creation_source: Mapped[Optional[str]] = mapped_column(
        String(50), nullable=True
    )  # 'discovered', 'created', 'imported'
    ...
    active_duration_seconds: Mapped[Optional[int]] = mapped_column(
