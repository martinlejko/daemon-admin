...
from sqlalchemy import Column, DateTime, Enum as SQLEnum, Integer, String, Text, Boolean
...
class Server(Base):
    ...
    ssh_key_passphrase_encrypted: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    auto_discover_services: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
